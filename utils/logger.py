...
def init_logger() -> logging.Logger:
    ...
    # select color_stream_handler based on platform
    import platform

    if platform.system() == 'Windows':
        color_stream_handler = _WinColorStreamHandler
    else:
        color_stream_handler = _AnsiColorStreamHandler

    steam_handler = color_stream_handler()
    ...
    discord_steam_handler = color_stream_handler()
